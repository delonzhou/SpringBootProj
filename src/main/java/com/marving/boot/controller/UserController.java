...
public class UserController {
    ...
    public void update(@PathVariable String id, @PathVariable String name){
        UserInfo userInfo = userRedisService.findById(id);
        if(userInfo == null)
            return;
        else{
            userInfo.setName(name);
            userRedisService.update(userInfo);
        }
    }
